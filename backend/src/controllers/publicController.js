...
//____________GET//api/public/catalog______________
...
//_______________get /api/public/product/:id__________________
...
//_________GET/ api/ public/categories________________
const getCategories =async (req,res) => {
    try{
        ...
        req.status(200).json({
            success: true,
            data: cats.map(c => ({ category : c._id, count:c.count})),
        })
...
//____________GET/api/puclic/silver/price____________
